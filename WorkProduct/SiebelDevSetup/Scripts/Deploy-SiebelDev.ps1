...
#  [string] $ResourceGroupName = 'SiebelDevDemo'  
#)

$ResourceGroupLocation = 'Central US'
$ResourceGroupName = 'siebeldev1'
$StorageTemplateFile = '..\Templates\SiebelStorage.json'
$VMTemplateFile = '..\Templates\SiebelVM.json'
$StorageTemplateParametersFile = '..\Templates\SiebelVM.param.json'
$VMTemplateParametersFile = '..\Templates\SiebelVM.param.json'
...
$DirRoot = 'C:\Users\mrochon\Documents\Premier\Siebel\SiebelDevSetup\Scripts\'
...
$ImageSource = 'https://siebeldevvms.blob.core.windows.net/images/'
$Dest = $StorageAccountContext.BlobEndPoint + 'images'

& $AzCopyPath /Source:$ImageSource, /Dest:$Dest, /DestKey:$StorageAccountKey, /Pattern:'Microsoft.Compute/Images/singlevm', "/S", "/XO", "/Y", "/V", "/Z:$DirRoot"
